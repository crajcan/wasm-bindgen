...
declare interface InitOutput {
  ...
  readonly wasm_bindgen__convert__closures__invoke1_mut__he68258f0fabeb3d4: (a: number, b: number, c: number) => void;
  readonly wasm_bindgen__convert__closures__invoke0_mut__hbb1f7bafbce7a2bc: (a: number, b: number) => void;
